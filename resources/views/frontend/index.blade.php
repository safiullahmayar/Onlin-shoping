            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 align-items-stretch video-box"
                        style='background-image: url("{{asset('frontend/assets/img/about.jpg')}}");'>
        ...
        <section id="chefs" class="chefs">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="member">
                            <div class="pic"><img src="{{asset('frontend/assets/img/chefs/chefs-2.jpg')}}" class="img-fluid"
                                    alt=""></div>
                            <div class="member-info">
                                <h4>Sarah Jhonson</h4>
                                <span>Patissier</span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="member">
                            <div class="pic"><img src="{{asset('frontend/assets/img/chefs/chefs-3.jpg')}}" class="img-fluid"
                                    alt=""></div>
                            <div class="member-info">
